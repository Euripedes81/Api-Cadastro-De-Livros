...
namespace ApiCadastroDeLivros.Repositories
{
    public class LivroRepository : IRepository<Livro>
    {
        ...
        public Task Atualizar(Livro objeto)
        {
        ...
        public Task<List<Livro>> Obter(string nome, string nomeAutor)
        {
            return Task.FromResult(livros.Values.Where(livro => livro.Nome.Equals(nome) && livro.AutorLivro.Nome.Equals(nomeAutor)).ToList());
        }
